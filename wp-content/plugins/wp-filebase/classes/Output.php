...
{		
	$content = '';
	$content .= '<h5 style="width:100%; margin-bottom:4%; padding-bottom: 2%; border-bottom: 1px solid #d8d8d8;">Archivos Adjuntos</h5>';//entra aqui para listar los Files adjuntos de Product Woocommerce
