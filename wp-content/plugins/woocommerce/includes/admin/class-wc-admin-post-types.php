...
class WC_Admin_Post_Types {
	...
	public function shop_coupon_columns( $existing_columns ) {
		$columns                = array();
		$columns["cb"]          = "<input type=\"checkbox\" />";
		$columns["coupon_code"] = __( 'Codigo', 'woocommerce' );
		$columns["type"]        = __( 'Tipo de Cupon', 'woocommerce' );
	...
	public function shop_order_columns( $existing_columns ) {
		...
		$columns['order_title']      = __( 'Orden', 'woocommerce' );
		...
		$columns['order_date']       = __( 'Fecha', 'woocommerce' );
		$columns['order_total']      = __( 'Total', 'woocommerce' );
		$columns['order_actions']    = __( 'Acciones', 'woocommerce' );
	...
	public function enter_title_here( $text, $post ) {
		switch ( $post->post_type ) {
			case 'product' :
				return __( 'Articulo Nombre', 'woocommerce' );
			break;
			case 'shop_coupon' :
				return __( 'Codigo de Cupon', 'woocommerce' );
			break;
		}
		return $text;
	}
