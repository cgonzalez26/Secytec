...
class WC_Admin_Meta_Boxes {
	...
	public function add_meta_boxes() {
		// Products
		add_meta_box( 'postexcerpt', __( 'Introducci&oacute;n', 'woocommerce' ), 'WC_Meta_Box_Product_Short_Description::output', 'product', 'normal' );
		add_meta_box( 'woocommerce-product-data', __( 'Product Data', 'woocommerce' ), 'WC_Meta_Box_Product_Data::output', 'product', 'normal', 'high' );
		add_meta_box( 'woocommerce-product-images', __( 'Galeria de Imagenes', 'woocommerce' ), 'WC_Meta_Box_Product_Images::output', 'product', 'side' );
