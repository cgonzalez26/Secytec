...
class WC_Product {
	...
	public function get_video_url() {
		return get_post_meta($this->id, '_video_url', true);
	}
	/**
	...
	public function get_categories( $sep = ', ', $before = '', $after = '' ) {
		//return get_the_term_list( $this->id, 'product_cat', $before, $sep, $after );//cristian
		return get_the_term_list_nuevo( $this->id, 'page_id', $before, $sep, $after );
	}
