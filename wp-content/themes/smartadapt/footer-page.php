	...
	<section class="slider">
		<div class="flexslider carousel">
		  <ul class="slides">		   
		    <?php
		    global $wpdb;
		    	$q    = "SELECT * FROM wp_bannerize WHERE wp_bannerize.group='eje".$_SESSION["eje"]."' ";
   ...
   <div class="g-grid">
	...
	<footer id="main-footer" class="main-footer" role="contentinfo">
		...
		<div id="divLogoMinisterio">
	    	...
	    	<img src="<?php echo esc_url( home_url( '/' ) )."/wp-content/uploads/2014/10/logo_MECyT.png"; ?>" alt="" style="height: auto;max-width: 100%;"/>
	    	</a>
		</div>
